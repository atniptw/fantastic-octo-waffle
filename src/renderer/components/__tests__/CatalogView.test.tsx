...
describe('CatalogView', () => {
  ...
  it('should display cosmetics when available', () => {
    render(<CatalogView 
      mods={[{ id: '1', mod_name: 'Test Mod', author: 'Author1', version: '1.0.0', iconData: null, source: 'test.zip' }]}
      cosmetics={[
  ...
  it('should display stats correctly', () => {
    render(<CatalogView 
      mods={[
        { id: '1', mod_name: 'Mod1', author: 'A', version: '1.0.0', iconData: null, source: 'a.zip' },
        { id: '2', mod_name: 'Mod2', author: 'B', version: '1.0.0', iconData: null, source: 'b.zip' },
      ]}
      cosmetics={[
  ...
  it('should filter cosmetics based on search query', () => {
    render(<CatalogView 
      mods={[{ id: '1', mod_name: 'Test Mod', author: 'Author1', version: '1.0.0', iconData: null, source: 'test.zip' }]}
      cosmetics={[
        { id: '1', mod_id: '1', display_name: 'Cool Hat', filename: 'cool_hat.hhh', hash: 'abc123', type: 'decoration', internal_path: 'path1' },
        { id: '2', mod_id: '1', display_name: 'Nice Shoes', filename: 'shoes.hhh', hash: 'def456', type: 'decoration', internal_path: 'path2' },
      ]}
    />);
